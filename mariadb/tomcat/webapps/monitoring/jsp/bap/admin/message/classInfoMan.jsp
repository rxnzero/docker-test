...
<script language="javascript" >
 ...
 $(document).ready(function() {	
	...
	$('#grid').jqGrid({
		datatype:"json",
		mtype: 'POST',
		url: '<c:url value="/bap/admin/message/classInfoMan.json" />',
		postData : gridPostData,
		colNames:['전문클래스명',
                  '전문클래스 설명'
                  ],
		colModel:[
				{ name : 'TELGMCLSNAME'  	, align:'left'		,width:40	,sortable:false  },
				{ name : 'TELGMCLSDESC'          , align:'left'	,width:40  },
				],
        jsonReader: {
             repeatitems:false
        },	          
