			...
			<div class="content_middle" id="content_middle">
				...
				<form id="ajaxForm">
					<table class="table_row" cellspacing="0">
						...
						<tr>
							<th>메시지메타구분코드</th><td><div class="select-style"><select type="text" name="msgMetaDstcd"></select></div> </td>
						</tr>
						<tr>
							<th>전문클래스명</th><td><div class="select-style"><select type="text" name="telgmClsName"></select></div> </td>
						</tr>		
					</table>
				</form>
