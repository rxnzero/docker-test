...
<script language="javascript" >
 ...
 $(document).ready(function() {	
	...
	$('#grid').jqGrid({
		datatype:"json",
		mtype: 'POST',
		url: '<c:url value="/bap/admin/message/classMapMan.json" />',
		...
		colModel:[
				{ name : 'TELGMCLSID'  	, align:'left'		,width:40	,sortable:false  },
				{ name : 'MSGMETADSTCD'          , align:'left'	,width:40  },
				{ name : 'TELGMCLSNAME' , align:'left' , width:40	}	
				],
        jsonReader: {
             repeatitems:false
        },	          
		...
		ondblClickRow: function(rowId) {
            ...
            var key = rowData['TELGMCLSID'];
            var url = '<c:url value="/bap/admin/message/classMapMan.view" />';
            url = url + '?cmd=DETAIL';
		...
		<div class="right_box">
			...
			<div class="content_middle" id="content_middle">
				...
				<table class="search_condition" cellspacing=0;>
					<tbody>
						<tr>							
							<th style="width:150px;">전문클래스ID</th>
