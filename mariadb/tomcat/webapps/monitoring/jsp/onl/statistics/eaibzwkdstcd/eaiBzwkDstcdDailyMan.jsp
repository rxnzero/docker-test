...
var url      ='<c:url value="/onl/statistics/eaibzwkdstcd/eaiBzwkDstcdDailyMan.json" />';
var url_view ='<c:url value="/onl/statistics/eaibzwkdstcd/eaiBzwkDstcdDailyMan.view" />';
	...
	<body>		
		<div class="right_box">
			...
			<div class="content_middle">
				...
				<div class="title">업무별 일별 거래현황</div>
