	...
	<body>		
		<div class="right_box">
			...
			<div class="content_middle" id="content_middle">
				...
				<div class="title"><%= localeMessage.getString("property.title") %><span class="tooltip"><%= localeMessage.getString("property.tooltip") %></span></div>
				<table class="search_condition" cellspacing=0;>
					<tbody>
						<tr>
							<th style="width:180px;"><%= localeMessage.getString("property.search") %></th>
							<td>
