	...
	<body>
		<div class="right_box">
			...
			<div class="content_middle">
				...
				<div class="title">라우팅 B2B 기관 정보</div>	
				<form id="ajaxForm">
					<table class="table_row" cellspacing="0">
						<tr>
							<th style="width:20%;">기관 코드</th>
						...
						<tr>
							...
							<td style="width:30%;">
								...
								<select name="svcPrcssNo" />
								</div>
							</td>
							<th style="width:20%;">수동인터페이스유형</th>
							<td style="width:30%;">
								<div class="select-style">
								<select name="psvIntfacDsticName"/> 
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="select-style">
								<select name="psvSysBzwkDstcd"/> 
								</div>
							</td>
							<th>수동시스템ID</th>
							<td>
								<div class="select-style">
								<select name="psvSysIdName"/> 
								</div>
							</td>
						</tr>
						<tr>
							<th>수동시스템서비스코드</th>
							<td><input type="text" name="psvSysSvcDsticName"/> </td>
							<th>수동시스템인터페이스유형</th>
							<td>
								<div class="select-style">
								<select name="psvSysAdptrBzwkGroupName"/> 
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="select-style">
								<select name="chngEonot"/> 
								</div>
							</td>
						</tr>
						<tr>
							<th>변환메시지ID</th>
							<td colspan="3"><input type="text" name="chngMsgIdName"/> </td>
						</tr>
						<tr>
							<th>기본응답메시지비교값</th>
							<td><input type="text" name="bascRspnsMsgCmprCtnt"/> </td>
							<th>기본응답변환유무</th>
							<td>
								<div class="select-style">
								<select name="bascRspnsChngEonot"/> 
								</div>
							</td>								
						</tr>
						<tr>
							<th>기본응답변환메시지ID</th>
							<td colspan="3"><input type="text" name="bascRspnsChngMsgIdName"/> </td>							
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<div class="select-style">
								<select name="supplDelYn"/> 
								</div>
							</td>
							<th>헤더제어구분코드</th>
							<td>
								<div class="select-style">
								<select name="hdrCtrlDstcd"/> 
								</div>
							</td>
						</tr>
						<tr>
