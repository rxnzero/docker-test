...
var url      = '<c:url value="/onl/admin/service/addB2bMan.json" />';
var url_view = '<c:url value="/onl/admin/service/addB2bMan.view" />';
...
function srcGridRendering(){
	$('#grid').jqGrid({
		...
		colModel:[
				{ name : 'CHNNLNM'   , align:'left'	,sortable:false  }
				],
        jsonReader: {
             repeatitems:false
        },
...
//var tgtPostData = getSearchForJqgrid("cmd","LIST"); //jqgrid에서는 object 로
	...
	$('#targetGrid').jqGrid({
		...
		colModel:[
				{ name : 'CHNNLNM'   , align:'left'		,key:true	,sortable:false  }
				],
        jsonReader: {
             repeatitems:false
        },
...
$(document).ready(function() {
	...
	$("#btn_modify").click(function(e){
		...
		postData = new Object();
		postData["cmd"] = "UPDATE_B2BPRPTY";
		postData["b2bChnnls"] = chkList.join(";");
	...
	<body>
		<div class="right_box">
			...
			<div class="content_middle">
				...
				<div class="title">B2b 프로퍼티 관리</div>
