...
var url      = '<c:url value="/onl/admin/control/controlChannelMan.json" />';
var url_view = '<c:url value="/onl/admin/control/controlChannelMan.view" />';
...
$(document).ready(function() {	
	...
	<div class="container" id="title">
		<div class="left full ">
			<p class="title"><img class="title_image" src="<c:url value="/images/title_bullet.gif"/>">대외채널 구분코드별 거래통제현황</p>
		</div>
	</div>	
	<!-- line -->
	<div class="container">
