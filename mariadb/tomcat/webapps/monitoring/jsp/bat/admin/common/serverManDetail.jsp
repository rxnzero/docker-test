...
$(document).ready(function() {	
	...
	var url ='<c:url value="/bat/admin/common/serverMan.json" />';
	var key ="${param.eaiSevrInstncName}";
	titleControl(key);
	buttonControl(key);
	...
	<body>
		<div class="right_box">
			...
			<div class="content_middle">
				...
				<div class="title">IF서버<span class="tooltip">EAI배치 서버 정보를 수정,삭제 합니다. EAI배치 서버 간 동기화를 위한 중요한 자료이므로 주의를 요합니다.</span></div>						
				
				<form id="ajaxForm">
					<table class="table_row" cellspacing="0">
						<tr>
							<th style="width:20%;">IF서버인스턴스명</th>
