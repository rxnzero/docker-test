...
$(document).ready(function() {	
	...
	$('#grid').jqGrid({
		datatype:"json",
		mtype: 'POST',
		url: '<c:url value="/bat/admin/common/codeMan.json" />',
		postData : gridPostData,
		colNames:['오류메시지 코드',
                  '오류메시지'
                  ],
		colModel:[
				{ name : 'MSGID'    , align:'left'	,sortable:false  },
		...
		ondblClickRow: function(rowId) {
            ...
            var url = '<c:url value="/bat/admin/common/codeMan.view" />';
            url = url + '?cmd=DETAIL';
				...
				<table class="search_condition" cellspacing=0;>
					<tbody>
						<tr>
							...
							<td>
								<input type="text" name="searchMsg" value="${param.searchMsg}">
							</td>
						</tr>
					</tbody>
				</table>
