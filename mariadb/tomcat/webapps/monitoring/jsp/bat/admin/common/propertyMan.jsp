...
$(document).ready(function() {	
	...
	$('#grid').jqGrid({
		datatype:"json",
		mtype: 'POST',
		url: '<c:url value="/bat/admin/common/propertyMan.json" />',
		postData : gridPostData,
		colNames:['프라퍼티 그룹명',
                  '프라퍼티 그룹설명'
                  ],
		colModel:[
				{ name : 'PRPTYGROUPID'    , align:'left'	,sortable:false  },
				{ name : 'PRPTYGROUPNAME'  , align:'left'  }
				],
        jsonReader: {
             repeatitems:false
        },	          
		...
		ondblClickRow: function(rowId) {
            ...
            var prptyGroupId = rowData['PRPTYGROUPID'];
            var url = '<c:url value="/bat/admin/common/propertyMan.view" />';
            url = url + '?cmd=DETAIL';
            ...
            //key값
            url = url + '&prptyGroupId='+prptyGroupId;
            goNav(url);
        }		
	});
				...
				<table class="search_condition" cellspacing=0;>
					<tbody>
						<tr>
							...
							<td>
								<input type="text" name="searchPrptyGroupId" value="${param.searchPrptyGroupId}">
							</td>							
						</tr>
					</tbody>
				</table>
