...
<script language="javascript" >
	...
	var url      = '<c:url value="/bat/transaction/interface/interfaceMonitorMan.json" />';
...
$(document).ready(function() {	
	...
	$('#grid').jqGrid({
		...
		colModel:[
				...
				{ name : 'MSGCNT'         , align:'right', width:50 },
	...
	<body>		
		<div class="right_box">
			...
			<div class="content_middle" id="content_middle">
				...
				<div class="title">인터페이스 별 모니터링</div>
				<table class="search_condition" cellspacing=0;>
					<tbody>
						<tr>
							...
							<td>
								<div class="select-style">
									<select name="searchErrorVal" value="${param.searchErrorVal}" style="width:120%;">
										<option value="">전체</option>
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" name="searchStartYYYYMMDD" maxlength="10" value="" size="10" style="width:100px;">
								<input type="text" name="searchStartHHMM" maxlength="8" value="" size="8" style="width:100px;"> ~
								<input type="text" name="searchEndYYYYMMDD" maxlength="10" value="" size="10" style="width:100px;">
								<input type="text" name="searchEndHHMM" maxlength="8" value="" size="8" style="width:100px;">
