		...
		$("#btn_modify").click(function() {
			...
			$.ajax({
				...
				success : function(args) {
					...
					alert("<%= localeMessage.getString("monitoringPropDetail.syncMsg") %>"+args.result);
	...
	<body>
		<div class="right_box">
			...
			<div class="content_middle" id="title">
				...
				<div class="title"><%= localeMessage.getString("monitoringPropDetail.title") %></div>	
				...
				<table class="table_row" cellspacing="0">
					<tr>
						<th style="width:180px;"><%= localeMessage.getString("propertyDetail.propertyKey") %></th>
						<td>
