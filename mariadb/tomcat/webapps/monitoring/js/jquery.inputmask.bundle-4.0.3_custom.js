        ...
        function maskScope(actionObj, maskset, opts) {
            ...
            var EventHandlers = {
                ...
                mouseleaveEvent: function mouseleaveEvent(e) {
                    ...
                    if (opts.clearMaskOnLostFocus && activeElement !== input) {
                ...
                mouseenterEvent: function mouseenterEvent(e) {
                    ...
                    if (activeElement !== input && opts.showMaskOnHover) {
                    ...
                    function patchValueProperty(npt) {
                        ...
                        function getter() {
                            if (this.inputmask) {
                                ...
                                return this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : getLastValidPosition() !== -1 || opts.nullable !== true ? activeElement === this && opts.clearMaskOnLostFocus ? (isRTL ? clearOptionalTail(getBuffer().slice()).reverse() : clearOptionalTail(getBuffer().slice())).join("") : valueGet.call(this) : "";
